 ...
 */
final case class ScalaBigDecimalCodec(mc: MathContext) extends Codec[BigDecimal] with CodecToString {
  ...
  def fromDirectString(value: String) = BigDecimal(value, mc)
}
